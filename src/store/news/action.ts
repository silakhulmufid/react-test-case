import { GET_ARTICLE, GET_INFINITE_NEWS, GET_NEWS, GET_NEWS_TOP_HEADLINES } from "./constant";
import type { IActionGetArticle, IActionGetNews, IActionGetNewsTopHeadlines } from "./type";
